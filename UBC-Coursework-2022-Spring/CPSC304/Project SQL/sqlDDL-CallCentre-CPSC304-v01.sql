CREATE TABLE IF NOT EXISTS CallCentres(
	...
	ManagerName CHAR(50),
	PhoneLineCount INT,
	FOREIGN KEY (Address) REFERENCES CallCentrePhonebook
);
...
INSERT INTO Agent (AgentID, Salary, AName, Email, PhoneNum)
	VALUES (8, 47800, Montgomery Burns, montybnuclear@springfield.com, '6137786945');

INSERT INTO Agent (AgentID, Salary, AName, Email, PhoneNum)
	VALUES (9, 45200, Ringo Starr, drummerboy@gmail.com, '9059987272');

INSERT INTO Agent (AgentID, Salary, AName, Email, PhoneNum)
	VALUES (10, 61000, Angela Merkel, formerchancellor@gmail.com, '4162234546');
...
INSERT INTO Training (ModuleNum, TLength, TName)
	VALUES (101, 120, 'Intro To Call Centres');

INSERT INTO Training (ModuleNum, TLength, TName)
	VALUES (102, 240, 'Skills for Interacting with Customers');

INSERT INTO Training (ModuleNum, TLength, TName)
	VALUES (103, 240, 'Handling Difficult Customers');

INSERT INTO Training (ModuleNum, TLength, TName)
	VALUES (104, 60, 'Call Centre Performance Metrics');

INSERT INTO Training (ModuleNum, TLength, TName)
	VALUES (105, 480, 'Advanced Technical Training');
